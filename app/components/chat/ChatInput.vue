<template>
  <div class="bg-white border-t border-black/10 h-[98px] md:h-[100px] shrink-0 flex items-start pt-[15px] md:pt-[17px] px-4 md:px-[87.5px]">
    <div class="w-full bg-[#f5f5f5] border-[1.5px] border-black/10 rounded-[14px] h-[67px] flex items-center gap-2 px-4 md:px-[17.5px] py-[13.5px]">
      <input
        ref="inputRef"
        v-model="message"
        type="text"
        :placeholder="placeholder || 'Ketik pesan Anda di sini...'"
        :disabled="loading"
